...
//
// Function for table, located in element with id = datatable-preRegistration
//
function TestTablePreRegistration(){
	$('#datatable-preRegistration').dataTable( {
		"aaSorting": [[ 0, "asc" ]],
		"sDom": "<'box-content-top'>rt<'box-content-pre'<'col-sm-3'l><'col-sm-3'i><'col-sm-6 text-right'p><'clearfix'>>",
		"sPaginationType": "bootstrap",
		"oLanguage": {
			"sSearch": "",
			"sLengthMenu": '_MENU_'
...
/*-------------------------------------------
	Functions for Dashboard page (dashboard.jsp)
---------------------------------------------*/
//
...
function LoadDatatablesReloadAjax(){
	$.getScript('resources/plugins/datatables/fnReloadAjax.js', function(){
	});
}

function LoadDateTimePickerScript(){
	$.getScript('resources/plugins/bootstrap/bootstrap-datetimepicker.min.js', function(){
	});
}
